...
Replace this section with the supported versions for `cachekey`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `cachekey` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in cachekey.
